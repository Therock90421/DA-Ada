...
#SBATCH -o ret0_test.out        # Write the standard output to file named 'ret-<job_number>.out'
#SBATCH -e ret0_test.err        # Write the standard error to file named 'ret-<job_number>.err'
